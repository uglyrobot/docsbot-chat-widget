...
export const defaultLabels = {
  ...
  voiceCallReturn: "Back to chat",
  voiceCallMute: "Mute",
  voiceCallUnmute: "Unmute",
  voiceCallEnd: "End call",
  voiceCallRetry: "Retry",
  voiceCallTranscript: "Live call transcript",
  voiceCallCaller: "You",
  voiceCallAgent: "Agent",
  voiceCallConnecting: "Connecting…",
  voiceCallListening: "Listening…",
  voiceCallUserSpeaking: "You’re speaking…",
  voiceCallAgentSpeaking: "Agent is speaking…",
  voiceCallError: "The voice call could not connect. Please try again.",
