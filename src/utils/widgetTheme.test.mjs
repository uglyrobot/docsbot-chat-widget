...
test('normalizeWidgetTheme falls back to auto for unsupported values', () => {
	assert.equal(normalizeWidgetTheme(undefined), 'auto');
	assert.equal(normalizeWidgetTheme('sepia'), 'auto');
});
