import { defaultLabels as bundledDefaultLabels } from "../constants/defaultLabels.js";
 ...
 */
export function resolveBrowserLocale(preferenceList) {
  const list =
    Array.isArray(preferenceList) && preferenceList.length
      ? preferenceList
